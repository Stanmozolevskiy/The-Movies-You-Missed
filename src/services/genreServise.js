...
export function serchMovieByGenre(genreId, page) {
  return http.get(
    `${baseUrl}3/discover/movie?api_key=${apiKey}&with_genres=${genreId}&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=true&page=${page}`
  );
}
