...
const Privacy = () => {
  return (
    <div className="container" style={{marginTop: "5%", marginBottom: "5%"}}>
      ...
      Movie Apes is located at:
      <br />
      <address>
        Movie Apes
        <br />
        64 Market street Portsmouth <br />
        03801 - NH , United States
        <br />
        6039696375{" "}
      </address>
      <p>
        It is Movie Apes's policy to respect your privacy regarding any
        information we may collect while operating our website. This Privacy
        Policy applies to{" "}
        <a href="https://www.movieapes.com">https://www.movieapes.com</a>
        (hereinafter, "us", "we", or "https://www.movieapes.com"). We respect
      ...
      <p>
        Like most website operators, Movie Apes collects
        ...
        request. Movie Apes's purpose in collecting non-personally identifying
        information is to better understand how Movie Apes's visitors use its
        website. From time to time, Movie Apes may release
        non-personally-identifying information in the aggregate, e.g., by
        publishing a report on trends in the usage of its website.
      </p>
      <p>
        Movie Apes also collects potentially personally-identifying information
        like Internet Protocol (IP) addresses for logged in users and for users
        leaving comments on https://www.movieapes.com blog posts. Movie Apes
      ...
      <p>
        Certain visitors to Movie Apes's websites choose to interact with Movie
        Apes in ways that require Movie Apes to gather personally-identifying
        information. The amount and type of information that Movie Apes gathers
        depends on the nature of the interaction. For example, we ask visitors
        who sign up for a blog at https://www.movieapes.com to provide a
      ...
      <p>
        ...
        Privacy Policy covers the use of cookies by Movie Apes and does not
      ...
      <h2>Https://www.movieapes.com uses Google AdWords for remarketing</h2>
      <p>
        Https://www.movieapes.com uses the remarketing services to advertise on
      ...
      <p>
        Movie Apes may collect statistics about the behavior of visitors to its
        website. Movie Apes may display this information publicly or provide it
        to others. However, Movie Apes does not disclose your
        personally-identifying information.
      </p>
      <h2>Cookies</h2>
      <p>
        To enrich and perfect your online experience, Movie Apes uses "Cookies",
      ...
      <p>
        ...
        time the visitor returns. Movie Apes uses cookies to help Movie Apes
        identify and track visitors, their usage of https://www.movieapes.com,
        and their website access preferences. Movie Apes visitors who do not
        wish to have cookies placed on their computers should set their browsers
        to refuse cookies before using Movie Apes's websites, with the drawback
        that certain features of Movie Apes's websites may not function properly
        without the aid of cookies.
      </p>
      <p>
        By continuing to navigate our website without changing your cookie
        settings, you hereby acknowledge and agree to Movie Apes's use of
        cookies.
      </p>
      <h2>E-commerce</h2>
      <p>
        Those who engage in transactions with Movie Apes – by purchasing Movie
        Apes's services or products, are asked to provide additional
        information, including as necessary the personal and financial
        information required to process those transactions. In each case, Movie
        Apes collects such information only insofar as is necessary or
        appropriate to fulfill the purpose of the visitor's interaction with
        Movie Apes. Movie Apes does not disclose personally-identifying
      ...
      <p>
        Although most changes are likely to be minor, Movie Apes may change its
        Privacy Policy from time to time, and in Movie Apes's sole discretion.
        Movie Apes encourages visitors to frequently check this page for any
      ...
      <p>
        ...
        via <a href="mailto:stanmozolevskiy@gmail.com">email</a> or{" "}
        <a href="tel:6039696375">phone</a>.
      </p>
    </div>
  );
};
